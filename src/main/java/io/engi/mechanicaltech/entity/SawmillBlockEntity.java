...
public class SawmillBlockEntity extends AbstractDirectProcessorBlockEntity {
	...
	public boolean canReceive(Direction direction, Identifier identifier) {
		return direction == getFront() && identifier.equals(PAYLOAD_ENERGY);
	}
	...
	protected Text getContainerName() {
		return new TranslatableText("block.mechanicaltech.sawmill");
	}

	@Override
	protected ScreenHandler createScreenHandler(int syncId, PlayerInventory playerInventory) {
		return new SawmillScreenHandler(syncId, playerInventory, this, this.propertyDelegate);
	}
